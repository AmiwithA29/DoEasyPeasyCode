import { ArrowLeft, Code2, UserPlus, Mail, Lock, User, Eye, EyeOff } from 'lucide-react';
      ...
      <div className="w-full max-w-md">
        ...
        <div className="rounded-xl border border-bg-border bg-bg-surface p-8 shadow-2xl">
          ...
          <p className="mt-2 text-sm text-text-muted">
            Start understanding code, one step at a time.
          </p>
          ...
          <form className="mt-6 space-y-4" onSubmit={(e) => e.preventDefault()}>
            ...
            <label className="flex items-start gap-2 text-sm text-text-muted">
              <input type="checkbox" className="mt-0.5 h-4 w-4 rounded border-bg-border bg-bg accent-amber" />
          ...
          <p className="mt-6 text-center text-sm text-text-muted">
            ...
            <a href="#signin" className="font-semibold text-accent-amber transition-colors hover:text-accent-amber-hover">
              Sign in
            </a>
          </p>
        </div>
